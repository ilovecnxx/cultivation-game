...
func (h *PVEHandler) buildPlayerTeam(infos []PlayerFighterInfo) ([]*model.Fighter, error) {
	...
	for _, info := range infos {
		...
		fighter.BaseAttack = int64(info.Attack)
		fighter.BaseDefense = int64(info.Defense)
		fighter.BaseSpeed = int64(info.Speed)
		fighter.BaseHP = int64(info.HP)
		fighter.BaseMaxHP = int64(info.MaxHP)
		fighter.BaseDefense = int64(info.Defense)
		fighter.MP = info.MP
