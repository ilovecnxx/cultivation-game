<template>
  <div class="gh-root" :class="{ 'light-mode': !isDark }">
    ...
    <Teleport to="body">
      <van-popup v-model:show="modalVisible" position="center" :style="{ width:'420px; max-width:90vw; border-radius:12px; background:#1a1a2e' }" v-if="activeMenu?.key!=='map'&&activeMenu?.key!=='profession'&&activeMenu?.key!=='pigeon'&&activeMenu?.key!=='backpack'">
