...
export { slotInfo, tierInfo, realmBaseAttack, realmBaseStats, equipNames, generateEquip, equipVisual, EquipmentSlot, SlotStats, Equipment, EquipVisual } from '../composables/useEquipmentData';
