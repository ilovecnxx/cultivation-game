...
<van-tab title="战力" name="combat"/>
<van-tab title="境界" name="realm"/>
<van-tab title="财富" name="wealth"/>
</van-tabs>
<div v-if="loading" style="text-align:center;padding:30px;color:rgba(255,255,255,.3)">加载中...</div>
<div v-for="(r,i) in list" :key="r.player_id" style="display:flex;align-items:center;gap:10px;padding:8px 0;border-bottom:1px solid rgba(255,255,255,.05)">
